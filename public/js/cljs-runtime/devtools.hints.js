...
var temp__5802__auto___13172 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___13172)){
var seen_errors_13175 = temp__5802__auto___13172;
if(cljs.core.truth_(seen_errors_13175.has(self))){
} else {
seen_errors_13175.add(self);

var temp__5804__auto___13176 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___13176)){
var sense_13177 = temp__5804__auto___13176;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13177)].join(''));
} else {
}
}
} else {

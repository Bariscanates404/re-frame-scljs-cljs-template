...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16766 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16766(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16767 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16767(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16769 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16769(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16770 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16770(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16771 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16771(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16772 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16772(reader);
}
});
...
var G__16793 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__16794 = s.append(c);
c = G__16793;
s = G__16794;
continue;
}

...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25281 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_25281(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25286 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_25286(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25291 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_25291(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25296 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_25296(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25301 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_25301(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25304 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_25304(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_25309 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_25309(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25315 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_25315(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25318 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_25318(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25322 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_25322(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25324 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_25324(b);
}
});

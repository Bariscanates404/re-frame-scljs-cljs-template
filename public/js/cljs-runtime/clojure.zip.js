...
var G__20996 = clojure.zip.node(loc);
var fexpr__20995 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__20995.cljs$core$IFn$_invoke$arity$1 ? fexpr__20995.cljs$core$IFn$_invoke$arity$1(G__20996) : fexpr__20995.call(null, G__20996));
});
/**
...
var G__21002 = clojure.zip.node(loc);
var fexpr__21001 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__21001.cljs$core$IFn$_invoke$arity$1 ? fexpr__21001.cljs$core$IFn$_invoke$arity$1(G__21002) : fexpr__21001.call(null, G__21002));
} else {
...
var fexpr__21003 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__21003.cljs$core$IFn$_invoke$arity$2 ? fexpr__21003.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__21003.call(null, node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__21015 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21015,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21015,(1),null);
var vec__21018 = clojure.zip.children(loc);
...
var vec__21034 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21034,(0),null);
var map__21037 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21034,(1),null);
var map__21037__$1 = cljs.core.__destructure_map(map__21037);
var path = map__21037__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21037__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21037__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21037__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21037__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21037__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21049__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__21050 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21049__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__21056 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21056,(0),null);
var map__21059 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21056,(1),null);
var map__21059__$1 = cljs.core.__destructure_map(map__21059);
var path = map__21059__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21059__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21059__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
return r;
} else {
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21074__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21074__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
...
var vec__21081 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21081,(0),null);
var map__21084 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21081,(1),null);
var map__21084__$1 = cljs.core.__destructure_map(map__21084);
var path = map__21084__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21084__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21084__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5000__auto__ = path;
if(cljs.core.truth_(and__5000__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__21107 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21107,(0),null);
var map__21110 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21107,(1),null);
var map__21110__$1 = cljs.core.__destructure_map(map__21110);
var path = map__21110__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21110__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
while(true){
if((i__5727__auto___21187 < len__5726__auto___21181)){
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq21116){
...
var G__21195 = clojure.zip.rightmost(child);
loc__$1 = G__21195;
continue;
} else {
return loc__$1;
...
var vec__21138 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21138,(0),null);
var map__21141 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21138,(1),null);
var map__21141__$1 = cljs.core.__destructure_map(map__21141);
var path = map__21141__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21141__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21141__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21141__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21141__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__21198 = clojure.zip.rightmost(child);
loc__$1 = G__21198;
continue;
} else {
return loc__$1;

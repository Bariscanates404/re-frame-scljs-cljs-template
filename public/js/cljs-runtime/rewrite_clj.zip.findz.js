...
var len__5726__auto___21460 = arguments.length;
var i__5727__auto___21461 = (0);
while(true){
if((i__5727__auto___21461 < len__5726__auto___21460)){
args__5732__auto__.push((arguments[i__5727__auto___21461]));

var G__21462 = (i__5727__auto___21461 + (1));
i__5727__auto___21461 = G__21462;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__21312){
var vec__21313 = p__21312;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21313,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21304_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq21305){
var G__21306 = cljs.core.first(seq21305);
var seq21305__$1 = cljs.core.next(seq21305);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21306,seq21305__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__21316,p__21317){
var map__21319 = p__21316;
var map__21319__$1 = cljs.core.__destructure_map(map__21319);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21319__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21319__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21319__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21319__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__21320 = p__21317;
var map__21320__$1 = cljs.core.__destructure_map(map__21320);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21320__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21320__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var and__5000__auto__ = (r >= row);
if(and__5000__auto__){
var and__5000__auto____$1 = (r <= end_row);
if(and__5000__auto____$1){
var and__5000__auto____$2 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(r,row))?(c >= col):true);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21325_SHARP_){
var and__5000__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__21325_SHARP_) : p_QMARK_.call(null, p1__21325_SHARP_));
if(cljs.core.truth_(and__5000__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__21325_SHARP_)),pos);
} else {
return and__5000__auto__;
}
...
var G__21336 = zloc;
var G__21336__$1 = (((G__21336 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__21336) : f.call(null, G__21336)));
if((G__21336__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__21336__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__21341_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21341_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__21357_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__21357_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__21388_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__21388_SHARP_),v);
}));

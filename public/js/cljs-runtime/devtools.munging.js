...
var o12912 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12912["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12913 = temp__5802__auto____$1;
return (o12913["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__12776__auto___13435 = t;
(o__12776__auto___13435["cljs$lang$ctorPrWriter"]).call(o__12776__auto___13435,t,writer);
}catch (e12929){var __13436 = e12929;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12964 = num_code;
switch (G__12964) {
case (1):
return (185);
...
}catch (e13135){var _e__12806__auto__ = e13135;
return false;
}})())){
...
var vec__13137 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13137,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var o13173 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13173["dependencies_"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13174 = temp__5802__auto____$1;
return (o13174["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13191){
var vec__13192 = p__13191;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13192,(0),null);
...
var G__13455 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__13456 = cljs.core.butlast(remaining_tokens);
name_tokens = G__13455;
remaining_tokens = G__13456;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13186){
var G__13187 = cljs.core.first(seq13186);
var seq13186__$1 = cljs.core.next(seq13186);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13187,seq13186__$1);
}));
...
var vec__13202 = cljs.core.split_with((function (p1__13201_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__13201_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13202,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13202,(1),null);
...
var vec__13213 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13213,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13213,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__13468 = cljs.core.rest(remaining_tokens);
var G__13469 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__13468;
name_tokens = G__13469;
continue;
} else {
...
var vec__13228 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13228,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13228,(1),null);
var vec__13231 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13231,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13231,(1),null);
var vec__13234 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13234,(3),null);
...
var vec__13249 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13249,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__13253 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13253,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13253,(1),null);
var vec__13257 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13257,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13257,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__13261 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__13261) : devtools.munging.parse_fn_info_deep.call(null, G__13261));
})()));
}
} else {
return fn_info;
...
var G__13492 = (arity + (1));
var G__13493 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13270){
var vec__13271 = p__13270;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13271,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13271,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13282_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__13282_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13283_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__13283_SHARP_);
}),sorted_infos);
...
var G__13510 = (i__5727__auto___13509 + (1));
i__5727__auto___13509 = G__13510;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13288){
var vec__13289 = p__13288;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13289,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13284){
var G__13285 = cljs.core.first(seq13284);
var seq13284__$1 = cljs.core.next(seq13284);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13285,seq13284__$1);
}));
...
var map__13314 = options;
var map__13314__$1 = cljs.core.__destructure_map(map__13314);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13314__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13314__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13314__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13314__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13315 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13315,(5),null);
...
}catch (e13329){var _e__12806__auto__ = e13329;
...
var G__13540 = (obj[cljs.core.first(path)]);
var G__13541 = cljs.core.rest(path);
obj = G__13540;
path = G__13541;
continue;
} else {
...
var _STAR_ = (function (accum,p__13367){
var vec__13368 = p__13367;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13368,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13368,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13383){
var vec__13384 = p__13383;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13384,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13384,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13384,(2),null);
...
var post_process = (function (p__13413){
var vec__13415 = p__13413;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13415,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13415,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13393_SHARP_){
return (obj[cljs.core.first(p1__13393_SHARP_)]);
}),sorted_matches);

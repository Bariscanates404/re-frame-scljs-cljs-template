...
var i_27058 = (self__.level + (1));
while(true){
if((i_27058 <= (new_level + (1)))){
(update[i_27058] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_27060 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_27060[i]));
} else {
x__$2.forward.push((((i < links_27060.length))?(links_27060[i]):null));
}

if((i < links_27060.length)){
(links_27060[i] = x__$2);
} else {
links_27060.push(x__$2);
}
...
var i_27062 = (0);
while(true){
if((i_27062 <= self__.level)){
var links_27063 = (update[i_27062]).forward;
if((x__$1 === (((i_27062 < links_27063.length))?(links_27063[i_27062]):null))){
(links_27063[i_27062] = (x__$1.forward[i_27062]));

var G__27064 = (i_27062 + (1));
i_27062 = G__27064;
continue;
} else {
var G__27065 = (i_27062 + (1));
i_27062 = G__27065;
continue;
}
} else {

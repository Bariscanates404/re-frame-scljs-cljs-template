shadow$provide.module$node_modules$react_highlight_DOT_js$dist$main = function(global, require, module, exports) {
  module.exports = function(modules) {
    ...
    exports.default = (module && module.__esModule ? module : {default:module}).default;
  }, function(module, exports, __webpack_require__) {
    ...
    var _react2 = _interopRequireDefault(module), _propTypes = __webpack_require__(4);
    _propTypes = _interopRequireDefault(_propTypes);
    var _reactDom = __webpack_require__(14);
    __webpack_require__ = __webpack_require__(15);
    var _highlight2 = _interopRequireDefault(__webpack_require__);
    __webpack_require__ = function(_Component) {
      function Highlight() {
        if (!(this instanceof Highlight)) {
          throw new TypeError("Cannot call a class as a function");
        }
        var call = (Highlight.__proto__ || Object.getPrototypeOf(Highlight)).apply(this, arguments);
        if (!this) {
      ...
      _createClass(Highlight, [{key:"componentDidMount", value:function() {
        _highlight2.default.highlightBlock((0,_reactDom.findDOMNode)(this.refs.code));
      }}, {key:"componentDidUpdate", value:function() {
        _highlight2.default.initHighlighting.called = !1;
        _highlight2.default.highlightBlock((0,_reactDom.findDOMNode)(this.refs.code));
      }}, {key:"render", value:function() {
        var _props = this.props;
        return _react2.default.createElement("pre", {className:_props.className, style:_props.style}, _react2.default.createElement("code", {className:_props.language, ref:"code"}, _props.children));
      }}]);
      return Highlight;
    }(module.Component);
    __webpack_require__.propTypes = {children:_propTypes.default.node.isRequired, className:_propTypes.default.string, language:_propTypes.default.string, style:_propTypes.default.object};
    exports.default = __webpack_require__;
  }, function(module, exports) {
    module.exports = require("module$node_modules$react$index");
  }, function(module, exports, __webpack_require__) {
    (function(process) {
      var REACT_ELEMENT_TYPE = "function" === typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103;
      module.exports = __webpack_require__(6)(function(object) {
    ...
    module.versions = {};
    module.on = noop;
    module.addListener = noop;
    module.once = noop;
    module.off = noop;
    module.removeListener = noop;
    module.removeAllListeners = noop;
    module.emit = noop;
    module.prependListener = noop;
    module.prependOnceListener = noop;
    module.listeners = function(name) {
      return [];
    };
        ...
        var ITERATOR_SYMBOL = "function" === typeof Symbol && Symbol.iterator, ReactPropTypes = {array:createPrimitiveTypeChecker("array"), bool:createPrimitiveTypeChecker("boolean"), func:createPrimitiveTypeChecker("function"), number:createPrimitiveTypeChecker("number"), object:createPrimitiveTypeChecker("object"), string:createPrimitiveTypeChecker("string"), symbol:createPrimitiveTypeChecker("symbol"), any:createChainableTypeChecker(emptyFunction.thatReturnsNull), arrayOf:function(typeChecker) {
          ...
          return createChainableTypeChecker(function(props, propName, componentName, location, propFullName) {
            ...
            for (var key in props) {
              if (props.hasOwnProperty(key) && (propName = typeChecker(props, key, componentName, location, propFullName + "." + key, ReactPropTypesSecret), propName instanceof Error)) {
                return propName;
              }
            }
            return null;
          ...
          }) : (warning(!1, "Invalid argument supplied to oneOf, expected an instance of array."), emptyFunction.thatReturnsNull);
        }, oneOfType:function(arrayOfTypeCheckers) {
          if (!Array.isArray(arrayOfTypeCheckers)) {
            return warning(!1, "Invalid argument supplied to oneOfType, expected an instance of array."), emptyFunction.thatReturnsNull;
          }
          for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
            var checker = arrayOfTypeCheckers[i];
            if ("function" !== typeof checker) {
              return warning(!1, "Invalid argument supplied to oneOfType. Expected an array of check functions, but received %s at index %s.", getPostfixForTypeWarning(checker), i), emptyFunction.thatReturnsNull;
            }
          }
          return createChainableTypeChecker(function(props, propName, componentName, location, propFullName) {
            for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
              if (null == (0,arrayOfTypeCheckers[i])(props, propName, componentName, location, propFullName, ReactPropTypesSecret)) {
                return null;
              }
            }
    ...
    exports.thatReturns = makeEmptyFunction;
    exports.thatReturnsFalse = makeEmptyFunction(!1);
    exports.thatReturnsTrue = makeEmptyFunction(!0);
    exports.thatReturnsNull = makeEmptyFunction(null);
    exports.thatReturnsThis = function() {
      return this;
    };
    ...
    (function(process) {
      ...
      process = function(condition, format) {
        if (void 0 === format) {
    ...
    (function(process) {
      var invariant = __webpack_require__(8), warning = __webpack_require__(9), ReactPropTypesSecret = __webpack_require__(11), loggedTypeFailures = {};
    ...
    module.exports = require("module$node_modules$react_dom$index");
  }, function(module, exports) {
    module.exports = require("module$node_modules$highlight_DOT_js$lib$index");
  }]);
};

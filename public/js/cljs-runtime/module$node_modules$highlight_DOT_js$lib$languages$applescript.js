shadow$provide.module$node_modules$highlight_DOT_js$lib$languages$applescript = function(global, require, module, exports) {
  module.exports = function(hljs) {
    var STRING = hljs.inherit(hljs.QUOTE_STRING_MODE, {illegal:""}), PARAMS = {className:"params", begin:"\\(", end:"\\)", contains:["self", hljs.C_NUMBER_MODE, STRING]}, COMMENT_MODE_1 = hljs.COMMENT("--", "$"), COMMENT_MODE_2 = hljs.COMMENT("\\(\\*", "\\*\\)", {contains:["self", COMMENT_MODE_1]});
    ...
    PARAMS]}].concat([COMMENT_MODE_1, COMMENT_MODE_2, hljs.HASH_COMMENT_MODE]), illegal:"//|-\x3e|\x3d\x3e|\\[\\["};
  };
};

...
var vec__23201 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__23204 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23204,(0),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23201,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23201,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__23215){
var vec__23216 = p__23215;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23216,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23216,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23220,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23220,(1),null);
...
var vec__23237 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23237,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23237,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23237,(2),null);
var vec__23240 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23240,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23240,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23240,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__23255){
var vec__23256 = p__23255;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23256,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23256,(1),null);
...
var len__5726__auto___23342 = arguments.length;
var i__5727__auto___23343 = (0);
while(true){
if((i__5727__auto___23343 < len__5726__auto___23342)){
args__5732__auto__.push((arguments[i__5727__auto___23343]));

var G__23344 = (i__5727__auto___23343 + (1));
i__5727__auto___23343 = G__23344;
continue;
} else {
}
break;
...
return zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5733__auto__);
});

(zprint.core.czprint_str_internal.cljs$core$IFn$_invoke$arity$variadic = (function (internal_options,coll,rest){
var vec__23264 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23264,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23264,(1),null);
...
var G__23267 = zprint.core.parse_string_all_options(rest_options);
var G__23268 = zprint.core.czprint_str_internal;
var G__23269 = ":parse-string-all? call";
var G__23270 = (function (){var G__23274 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__23274) : zprint.zutil.edn_STAR_.call(null, G__23274));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__23267,G__23268,G__23269,G__23270) : zprint.core.process_multiple_forms.call(null, G__23267,G__23268,G__23269,G__23270));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__23280 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23280,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23280,(1),null);
...
/** @this {Function} */
(zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq23259){
...
var or__5002__auto__ = (function (){try{return null;
}catch (e23283){var e = e23283;
return null;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
var args__5732__auto__ = [];
var len__5726__auto___23345 = arguments.length;
var i__5727__auto___23346 = (0);
while(true){
if((i__5727__auto___23346 < len__5726__auto___23345)){
args__5732__auto__.push((arguments[i__5727__auto___23346]));

var G__23347 = (i__5727__auto___23346 + (1));
i__5727__auto___23346 = G__23347;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq23284){
var G__23285 = cljs.core.first(seq23284);
var seq23284__$1 = cljs.core.next(seq23284);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23285,seq23284__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq23286){
var G__23287 = cljs.core.first(seq23286);
var seq23286__$1 = cljs.core.next(seq23286);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23287,seq23286__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq23288){
...
var G__23359 = (i__5727__auto___23358 + (1));
i__5727__auto___23358 = G__23359;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq23294){
var G__23295 = cljs.core.first(seq23294);
var seq23294__$1 = cljs.core.next(seq23294);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23295,seq23294__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__23300,form){
var vec__23301 = p__23300;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23301,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23301,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23301,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23301,(3),null);
...
var vec__23311 = (cljs.core.truth_((function (){var and__5000__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5000__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23311,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23311,(1),null);
...
var internal_options = (((function (){var or__5002__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
if(and__5000__auto____$1){
var or__5002__auto__ = new cljs.core.Keyword(null,"interpose","interpose",576140629).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"parse","parse",-1162164619).cljs$core$IFn$_invoke$arity$1(decision_options));
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var output_str = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || (((cljs.core.not((function (){var or__5002__auto____$1 = comment_QMARK_;
if(cljs.core.truth_(or__5002__auto____$1)){
return or__5002__auto____$1;
} else {
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([next_options__$1,new_options], 0)):(cljs.core.truth_((function (){var or__5002__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return whitespace_form_QMARK_;
...
)),output_str,(function (){var or__5002__auto__ = space_count;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return (0);
...
var forms = (function (){var G__23325 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__23325) : zprint.zutil.edn_STAR_.call(null, G__23325));
})();

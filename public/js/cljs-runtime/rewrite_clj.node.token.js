...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k20695,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k20695,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__20711){
var vec__20712 = p__20711;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20712,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20712,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20694){
var self__ = this;
var G__20694__$1 = this;
return (new cljs.core.RecordIter((0),G__20694__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this20696,other20697){
var self__ = this;
var this20696__$1 = this;
return (((!((other20697 == null)))) && ((((this20696__$1.constructor === other20697.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20696__$1.value,other20697.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20696__$1.string_value,other20697.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20696__$1.__extmap,other20697.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k20695){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k20695);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__20694){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__20726 = cljs.core.keyword_identical_QMARK_;
var expr__20727 = k__5309__auto__;
if(cljs.core.truth_((pred__20726.cljs$core$IFn$_invoke$arity$2 ? pred__20726.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__20727) : pred__20726.call(null, new cljs.core.Keyword(null,"value","value",305978217),expr__20727)))){
return (new rewrite_clj.node.token.TokenNode(G__20694,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__20726.cljs$core$IFn$_invoke$arity$2 ? pred__20726.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__20727) : pred__20726.call(null, new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__20727)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__20694,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__20694),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__20694){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__20694,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__20700){
var extmap__5342__auto__ = (function (){var G__20736 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__20700,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__20700)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__20736);
} else {
return G__20736;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__20700),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__20700),null,cljs.core.not_empty(extmap__5342__auto__),null));
});

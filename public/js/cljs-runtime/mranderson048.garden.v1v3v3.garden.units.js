 ...
 */
mranderson048.garden.v1v3v3.garden.units.convert = (function mranderson048$garden$v1v3v3$garden$units$convert(p__17326,right){
var map__17327 = p__17326;
var map__17327__$1 = cljs.core.__destructure_map(map__17327);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17327__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17327__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var temp__5804__auto__ = cljs.core.re_matches(mranderson048.garden.v1v3v3.garden.units.unit_re,s);
if(cljs.core.truth_(temp__5804__auto__)){
var vec__17340 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17340,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17340,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17340,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17349__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17350 = u(y);
var map__17350__$1 = cljs.core.__destructure_map(map__17350);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17350__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
while (G__17440__i < G__17440__a.length) {G__17440__a[G__17440__i] = arguments[G__17440__i + 2]; ++G__17440__i;}
  more = new cljs.core.IndexedSeq(G__17440__a,0,null);
} 
...
while (G__17443__i < G__17443__a.length) {G__17443__a[G__17443__i] = arguments[G__17443__i + 2]; ++G__17443__i;}
G__17442 = new cljs.core.IndexedSeq(G__17443__a,0,null);
}
return mranderson048$garden$v1v3v3$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17442);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17354__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17355 = u(y);
var map__17355__$1 = cljs.core.__destructure_map(map__17355);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17355__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var more = null;
if (arguments.length > 2) {
var G__17445__i = 0, G__17445__a = new Array(arguments.length -  2);
while (G__17445__i < G__17445__a.length) {G__17445__a[G__17445__i] = arguments[G__17445__i + 2]; ++G__17445__i;}
  more = new cljs.core.IndexedSeq(G__17445__a,0,null);
} 
...
var y = cljs.core.first(arglist__17446);
var more = cljs.core.rest(arglist__17446);
...
while (G__17448__i < G__17448__a.length) {G__17448__a[G__17448__i] = arguments[G__17448__i + 2]; ++G__17448__i;}
G__17447 = new cljs.core.IndexedSeq(G__17448__a,0,null);
}
return mranderson048$garden$v1v3v3$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17447);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17357__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17358 = u(y);
var map__17358__$1 = cljs.core.__destructure_map(map__17358);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17358__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 * m2));
});
var mranderson048$garden$v1v3v3$garden$units$make_unit_multiplier_$_u_STAR___3 = (function() { 
var G__17449__delegate = function (x,y,more){
...
var G__17449 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__17450__i = 0, G__17450__a = new Array(arguments.length -  2);
while (G__17450__i < G__17450__a.length) {G__17450__a[G__17450__i] = arguments[G__17450__i + 2]; ++G__17450__i;}
  more = new cljs.core.IndexedSeq(G__17450__a,0,null);
} 
return G__17449__delegate.call(this,x,y,more);};
...
var more = cljs.core.rest(arglist__17451);
return G__17449__delegate(x,y,more);
});
...
var G__17452 = null;
if (arguments.length > 2) {
var G__17453__i = 0, G__17453__a = new Array(arguments.length -  2);
while (G__17453__i < G__17453__a.length) {G__17453__a[G__17453__i] = arguments[G__17453__i + 2]; ++G__17453__i;}
G__17452 = new cljs.core.IndexedSeq(G__17453__a,0,null);
}
return mranderson048$garden$v1v3v3$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17452);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17362__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__17363 = u(y);
var map__17363__$1 = cljs.core.__destructure_map(map__17363);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17363__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 / m2));
});
var mranderson048$garden$v1v3v3$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__17454__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__17455__i = 0, G__17455__a = new Array(arguments.length -  2);
while (G__17455__i < G__17455__a.length) {G__17455__a[G__17455__i] = arguments[G__17455__i + 2]; ++G__17455__i;}
  more = new cljs.core.IndexedSeq(G__17455__a,0,null);
} 
...
var G__17457 = null;
if (arguments.length > 2) {
var G__17458__i = 0, G__17458__a = new Array(arguments.length -  2);
while (G__17458__i < G__17458__a.length) {G__17458__a[G__17458__i] = arguments[G__17458__i + 2]; ++G__17458__i;}
G__17457 = new cljs.core.IndexedSeq(G__17458__a,0,null);
}
return mranderson048$garden$v1v3v3$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__17457);
}
throw(new Error('Invalid arity: ' + arguments.length));
};

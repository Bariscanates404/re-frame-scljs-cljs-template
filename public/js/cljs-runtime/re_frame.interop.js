...
return [(function (){var pred__23277 = cljs.core.instance_QMARK_;
var expr__23278 = reactive_val;
if(cljs.core.truth_((pred__23277.cljs$core$IFn$_invoke$arity$2 ? pred__23277.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23278) : pred__23277.call(null, reagent.ratom.RAtom,expr__23278)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23277.cljs$core$IFn$_invoke$arity$2 ? pred__23277.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23278) : pred__23277.call(null, reagent.ratom.RCursor,expr__23278)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23277.cljs$core$IFn$_invoke$arity$2 ? pred__23277.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23278) : pred__23277.call(null, reagent.ratom.Reaction,expr__23278)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23277.cljs$core$IFn$_invoke$arity$2 ? pred__23277.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23278) : pred__23277.call(null, reagent.ratom.Track,expr__23278)))){
return "tr";
} else {
return "other";
}

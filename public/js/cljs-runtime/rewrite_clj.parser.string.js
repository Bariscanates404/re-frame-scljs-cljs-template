...
var G__20977 = rewrite_clj.parser.string.flush_into(lines,buf);
...
var G__20979 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__20980 = lines;
escape_QMARK_ = G__20979;
lines = G__20980;
continue;
...
var G__20960 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__20960) : rewrite_clj.node.string_node.call(null, G__20960));
});
...
var G__20964 = cljs.core.re_pattern(regex);
var G__20965 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__20964,G__20965) : rewrite_clj.node.token_node.call(null, G__20964,G__20965));
});

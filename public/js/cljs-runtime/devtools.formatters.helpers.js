...
var G__13546 = devtools.prefs.pref(v);
v = G__13546;
continue;
} else {
return v;
...
}catch (e13495){var _e__12806__auto__ = e13495;
return false;
}})();
...
}catch (e13506){var _e__12806__auto__ = e13506;
return false;
}})();
...
}catch (e13511){var _e__12806__auto__ = e13511;
return false;
}}
}
});
...
var vec__13529 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13529,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13529,(1),null);
...
return cljs.core.some((function (p1__13532_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13532_SHARP_);
}),template);
});

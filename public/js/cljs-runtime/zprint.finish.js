...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__21580_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__21580_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__21580_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__21585){
var vec__21586 = p__21585;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21586,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21586,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__21591,s,color,element,idx){
var map__21592 = p__21591;
var map__21592__$1 = cljs.core.__destructure_map(map__21592);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21592__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21592__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21592__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__21597 = (function (){var or__5002__auto__ = color;
...
var fexpr__21596 = (function (){var G__21598 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__21598) : style_map.call(null, G__21598));
})();
return (fexpr__21596.cljs$core$IFn$_invoke$arity$1 ? fexpr__21596.cljs$core$IFn$_invoke$arity$1(G__21597) : fexpr__21596.call(null, G__21597));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__21599){
var vec__21600 = p__21599;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21600,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21600,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21600,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__21606){
var vec__21607 = p__21606;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21607,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21607,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21607,(2),null);
...
var G__21882 = cljs.core.next(ssv);
var G__21884 = (this_ssv == null);
var G__21885 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__21886 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__21882;
doing_nil_QMARK_ = G__21884;
last_elide = G__21885;
out = G__21886;
continue;
}
...
var vec__21659 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21659,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21659,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21659,(2),null);
...
var G__21904 = cljs.core.next(remaining_cvec);
var G__21905 = new_idx;
var G__21906 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__21904;
idx = G__21905;
out = G__21906;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__21676,cursor_vec){
var vec__21677 = p__21676;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21677,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21677,(1),null);
var focus_vec = vec__21677;
...
var vec__21680 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21680,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21680,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__21685){
var vec__21686 = p__21685;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21686,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21686,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__21695,existing_count){
var vec__21696 = p__21695;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21696,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21696,(1),null);
...
return cljs.core.filterv((function (p1__21691_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__21691_SHARP_))));
...
var vec__21718 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21718,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21718,(1),null);
var cvec_element = vec__21718;
if((cvec_element == null)){
var G__21920 = cljs.core.next(cvec_nl);
var G__21921 = (idx + (1));
var G__21922 = start;
var G__21923 = out;
cvec_nl = G__21920;
...
var G__21925 = cljs.core.next(cvec_nl);
var G__21926 = (idx + (1));
var G__21927 = idx;
var G__21928 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__21925;
idx = G__21926;
start = G__21927;
out = G__21928;
...
var G__21931 = cljs.core.next(cvec_nl);
var G__21932 = (idx + (1));
var G__21933 = (idx + (1));
var G__21934 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__21931;
idx = G__21932;
start = G__21933;
out = G__21934;
...
var G__21937 = cljs.core.next(cvec_nl);
var G__21938 = (idx + (1));
var G__21939 = idx;
var G__21940 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__21937;
idx = G__21938;
start = G__21939;
out = G__21940;
...
var G__21942 = cljs.core.next(cvec_nl);
var G__21943 = (idx + (1));
var G__21944 = start;
var G__21945 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__21942;
idx = G__21943;
start = G__21944;
out = G__21945;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__21746_SHARP_,p2__21745_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__21745_SHARP_)){
return cljs.core.reduced(p1__21746_SHARP_);
} else {
return (p1__21746_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__21757,p__21758){
var vec__21760 = p__21757;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21760,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21760,(1),null);
var vec__21763 = p__21758;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21763,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21763,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__21776,cvec,focus_vec){
var map__21777 = p__21776;
var map__21777__$1 = cljs.core.__destructure_map(map__21777);
var options = map__21777__$1;
var map__21778 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21777__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__21778__$1 = cljs.core.__destructure_map(map__21778);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21778__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21778__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21778__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21774_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__21774_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);

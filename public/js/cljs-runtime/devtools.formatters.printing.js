...
while(true){
if((i__5727__auto___13665 < len__5726__auto___13663)){
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13553){
var G__13554 = cljs.core.first(seq13553);
var seq13553__$1 = cljs.core.next(seq13553);
var G__13555 = cljs.core.first(seq13553__$1);
var seq13553__$2 = cljs.core.next(seq13553__$1);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13554,G__13555,seq13553__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13590_SHARP_){
return (!((cljs.core.meta(p1__13590_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13627__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13633){var _e__12806__auto__ = e13633;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13635){var _e__12806__auto__ = e13635;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13640 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13641 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13641);

try{var map__13643 = opts;
var map__13643__$1 = cljs.core.__destructure_map(map__13643);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13643__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13640);
}});
...
var temp__5802__auto___13697 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13697)){
var managed_print_level_13698 = temp__5802__auto___13697;
var _STAR_print_level_STAR__orig_val__13648_13699 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13649_13700 = managed_print_level_13698;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13649_13700);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13647_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13647_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13648_13699);
}} else {
job_fn();
}

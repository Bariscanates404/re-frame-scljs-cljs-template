...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__21254,k,f){
var vec__21255 = p__21254;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21255,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21255,(1),null);
var loc = vec__21255;
...
if(cljs.core.not((function (){var and__5000__auto__ = ploc;
...
var G__21285 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__21285;
continue;
}
break;
...
var G__21286 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__21286;
continue;
} else {
return zloc__$1;
...
var G__21288 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__21288;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__21266){
var vec__21267 = p__21266;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21267,(0),null);
var map__21270 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21267,(1),null);
var map__21270__$1 = cljs.core.__destructure_map(map__21270);
var path = map__21270__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21270__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__21267;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__21272){
var vec__21273 = p__21272;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21273,(0),null);
var map__21276 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21273,(1),null);
var map__21276__$1 = cljs.core.__destructure_map(map__21276);
var path = map__21276__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21276__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__21273;
if(cljs.core.seq(r)){
...
var vec__21277 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21277,(0),null);
var map__21280 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21277,(1),null);
var map__21280__$1 = cljs.core.__destructure_map(map__21280);
var path = map__21280__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21280__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21280__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21280__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21280__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
